...
Public Class Plan
    ...
    Public Sub loadAuditHistory()
        ...
        End Try
    End Sub
    Private Sub PlanBindingNavigatorSaveItem_Click(sender As Object, e As EventArgs)
        Try
            ...
            Me.WeekendingdateDropdownBindingSource.EndEdit()

            Me.Plan2PerRecordTableAdapter.Update(WeekendingdateDropdownBindingSource.DataSource)
...
endofsave:
    ...
    Private Sub Form2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.WeekendingdateTableAdapter1.Fill(Me.Sites.Plan)
        ...
        Me.PlanTypesDropdownSearchTableAdapter1.Fill(Me.Sites.PlanTypes)
        'TODO: This line of code loads data into the 'LexiconRecManagerDataSet.Branch' table. You can move, or remove it, as needed.
        Me.BranchTableAdapter1.Fill(Me.LexiconRecManagerDataSet.Branch)
        'TODO: This line of code loads data into the 'LexiconRecManagerDataSet.Branch' table. You can move, or remove it, as needed.
        Me.BranchTableAdapter1.Fill(Me.LexiconRecManagerDataSet.Branch)
        'TODO: This line of code loads data into the 'LexiconRecManagerDataSet.PlanView' table. You can move, or remove it, as needed.
        Me.PlanViewTableAdapter1.Fill(Me.LexiconRecManagerDataSet.PlanView)
        'TODO: This line of code loads data into the 'LexiconRecManagerDataSet3.PlanTypes' table. You can move, or remove it, as needed.
        Me.PlanTypesTableAdapter2.Fill(Me.LexiconRecManagerDataSet.PlanTypes)
        'TODO: This line of code loads data into the 'LexiconRecManagerDataSet.Plan1' table. You can move, or remove it, as needed.
        '   Me.Plan1TableAdapter.Fill(Me.LexiconRecManagerDataSet.Plan1, PlanSelect.SelectedValue.ToString, WeekSelect.SelectedValue.ToString, BranchSelect.SelectedValue.ToString)
        Main.BarEditItem1.EditValue = 0
        Me.SetStyle(ControlStyles.OptimizedDoubleBuffer, True)
        SetDoubleBuffered(LayoutControl1)
        SetDoubleBuffered(LayoutControl2)
        SetDoubleBuffered(LayoutControl3)
        SetDoubleBuffered(PlanViewDataGridView)
        ...
        Main.BarEditItem1.EditValue = 15

        'TODO: This line of code loads data into the 'LexiconRecManagerDataSet.Branch' table. You can move, or remove it, as needed.
        Me.BranchTableAdapter.Fill(Me.LexiconRecManagerDataSet.Branch)
        Main.BarEditItem1.EditValue = 30
        ...
        Main.BarEditItem1.EditValue = 45
        'TODO: This line of code loads data into the 'Sites.Plan' table. You can move, or remove it, as needed.
        Me.WeekendingdateTableAdapter1.Fill(Me.Sites.Plan)
        Main.BarEditItem1.EditValue = 60

        'TODO: This line of code loads data into the 'Sites.PlanTypes' table. You can move, or remove it, as needed.
        Me.PlanTypesDropdownSearchTableAdapter1.Fill(Me.Sites.PlanTypes)
        Main.BarEditItem1.EditValue = 70

        Me.JobCategoryTableAdapter.Fill(Me.LexiconRecManagerDataSet.JobCategory)
        Main.BarEditItem1.EditValue = 80

        'TODO: This line of code loads data into the 'LexiconRecManagerDataSet.JobCategory' table. You can move, or remove it, as needed.
        Me.SitesTableAdapter.Fill(Me.Sites._Sites)
        Main.BarEditItem1.EditValue = 90
        ...
        End If
        applyfilter()
        Main.BarEditItem1.EditValue = 100
    End Sub
    ...
    Private Sub PlanViewDataGridView_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles PlanViewDataGridView.CellClick
        Try
            ...
            Select Case PlanViewDataGridView.Item(2, PlanViewDataGridView.CurrentRow.Index).Value.ToString
                ...
                Case "L"
                    If GetSecurityInfo("Plan-LockdownUnlock") <> "" Then
                        ...
                        Me.Plan2PerRecordTableAdapter.Fill(Me.LexiconRecManagerDataSet.Plan2PerRecord, PlanViewDataGridView.Item(1, PlanViewDataGridView.CurrentRow.Index).Value.ToString)

                        loadAuditHistory()
                    Else
                        WeekendingdateDropdownBindingSource.Filter = "PlanID = 0"
                    End If
                Case "LP"
                    If GetSecurityInfo("Plan-LockAll") <> "" Then
                        'PlanBindingSource.Filter = "PlanID = " + PlanViewDataGridView.Item(1, PlanViewDataGridView.CurrentRow.Index).Value.ToString
                ...
                Case Else
                    ...
                    loadAuditHistory()
            End Select
            Main.BarEditItem1.EditValue = 20
            ...
            Main.BarEditItem1.EditValue = 40
    ...
    Private Sub PlanSelect_SelectedIndexChanged(sender As Object, e As EventArgs) Handles PlanSelect.SelectedIndexChanged, WeekSelect.SelectedIndexChanged, BranchSelect.SelectedIndexChanged
        Try
            Me.WeeknumbersTableAdapter.Fill(Me.LexiconRecManagerDataSet.Weeknumbers, CType(PlanSelect.Text, Date))
    ...
    Public Sub filter()
        ...
        Try
            ...
            Me.DataTable2TableAdapter.Fill(Me.LexiconRecManagerDataSet.DataTable2, WeekSelect.Text, BranchSelect.Text, PlanSelect.Text)
    ...
    Private Sub BindingNavigatorAddNewItem_Click(sender As Object, e As EventArgs)
        WeekendingdateDropdownBindingSource.AddNew()
        TextBox21.Text = ""
        ...
        Else
            ...
            If PlanIDTextBox.Text <= 0 Then
                ...
                Friday2CheckBox.Checked = False
                Saturday2CheckBox.Checked = False
                Sunday2CheckBox.Checked = False
                HoursTextBox.Text = 0
                OT1HoursTextBox.Text = 0
                OT2HoursTextBox.Text = 0
                OT3HoursTextBox.Text = 0
                SatHours.Text = 0
                SundayHours.Text = 0
                BankHours.Text = 0
    ...
    Private Sub PlanBindingSource1_AddingNew(sender As Object, e As System.ComponentModel.AddingNewEventArgs)
        ...
        Try
            ...
            Select Case PlanViewDataGridView.Item(2, PlanViewDataGridView.CurrentRow.Index).Value.ToString
                Case "L"
                    MsgBox("Record Locked", MsgBoxStyle.Exclamation)
                    If GetSecurityInfo("Plan-LockdownUnlock") <> "" Then
                        WeekendingdateDropdownBindingSource.Filter = "PlanID = " + PlanViewDataGridView.Item(1, PlanViewDataGridView.CurrentRow.Index).Value.ToString
                        WeekendingdateDropdownBindingSource.Position() = WeekendingdateDropdownBindingSource.Find("PlanID", PlanViewDataGridView.Item(1, PlanViewDataGridView.CurrentRow.Index).Value)
                        loadAuditHistory()
                    Else
                        WeekendingdateDropdownBindingSource.Filter = "PlanID = 0"
                    End If
    ...
    Private Sub ToolStripButton3_Click(sender As Object, e As EventArgs)
        Select Case TextBox22.Text
            ...
            Case Else
                ...
                ElseIf result = DialogResult.No Then
                ElseIf result = DialogResult.Yes Then
                    Me.WeekendingdateDropdownBindingSource.RemoveCurrent()
                End If
        End Select
    End Sub
