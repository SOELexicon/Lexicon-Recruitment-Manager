...
Public Class Reports_PlanSchemeCosting
    ...
    Public Sub loadreport()
        Try
            ...
            Me.Rpt_CostingsTableAdapter.Fill(Me.LexiconRecManagerDataSet.Rpt_Costings, ComboBox2.Text, ComboBox3.Text, ComboBox1.Text, ComboBox4.Text, ComboBox5.Text)
    ...
    Private Sub Reports_Planview_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'LexiconRecManagerDataSet.Rpt_Costings' 
        'TODO: This line of code loads data into the 'LexiconRecManagerDataSet.Rpt_Costings' table. You can move, or remove it, as needed.
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Message.Subject = "Plan Scheme Costing Report - " + ComboBox2.Text + " " + ComboBox3.Text + " " + ComboBox1.Text + " " + ComboBox4.Text + " " + ComboBox5.Text
    ...
    Private Sub ComboBox4_DisplayMemberChanged(sender As Object, e As EventArgs) Handles ComboBox4.DisplayMemberChanged, ComboBox4.SelectedIndexChanged
        If ComboBox4.Text <> "LTD" Then
            ComboBox5.Visible = False
            Label5.Visible = False
            ComboBox5.Text = ""

        Else
            Me.Rpt_PlanemployeesTableAdapter.Fill(Me.LexiconRecManagerDataSet.Rpt_Planemployees, ComboBox2.Text, ComboBox3.Text, ComboBox1.Text, ComboBox4.Text)
